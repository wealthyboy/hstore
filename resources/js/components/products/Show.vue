                    ...
                    <div class="mt-2">
                        ...
                        <div class="row no-gutters mb-2">
                            ...
                            <div v-if="$root.loggedIn" class="col-1">
                               ...
                               <span  style="" v-if="wishlistText"  class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                            </div>
                    ...
                    <div class="product-single-tabs">
                            ...
                            <div class="tab-content bg--gray">
                                <div class="tab-pane fade show active pl-2" id="product-desc-content" role="tabpanel" aria-labelledby="product-tab-desc">
                                    <div v-html="product.product.description" class="product-desc-content  pl-2 pb-2 color--primary"></div><!-- End .product-desc-content -->
                                </div><!-- End .tab-pane -->
